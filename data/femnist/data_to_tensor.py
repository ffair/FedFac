...
if __name__ == "__main__":
    by_writers_dir = os.path.join('/home/THY/mnist/femnist/intermediate', 'images_by_writer.pkl')
    save_dir = os.path.join('/home/THY/mnist/femnist/intermediate', 'data_as_tensor_by_writer')
